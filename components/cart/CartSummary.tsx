...
export function CartSummary() {
  ...
  return <aside className="cart-summary"><p>{cartCount} {cartCount === 1 ? 'piece' : 'pieces'} selected</p><div><span>Subtotal</span><b>{formatPrice(subtotal)}</b></div><CheckoutButton lines={cart} /></aside>;
}
